...
const AboutPage = () => {
    ...
    const [theme, setTheme] = useState(globalWindow.localStorage.getItem('themeColor') === THEME.light ? THEME.light : THEME.dark);
    ...
    return (
        ...
        <Navbar onClick={() =>
            ...
            windowLocal.setItem('themeColor', theme === THEME.light ? THEME.dark : THEME.light)}
          } color={theme}/>
